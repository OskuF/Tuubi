...
JsonParser_$1c666dcf50d5150ff2e96763d230d607.__name__ = true;
JsonParser_$1c666dcf50d5150ff2e96763d230d607.__super__ = json2object_reader_BaseParser;
JsonParser_$1c666dcf50d5150ff2e96763d230d607.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ y : Float, x : Float, clientName : String }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["clientName","x","y"],[false,false,false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
...
JsonParser_$237c3c85cf00342dfb7f01e6a6157d10.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonString: function(s,pos,variable) {
		this.value = this.loadString(s,pos,variable,["RawType","YoutubeType","VkType","TwitchType","IframeType"],"RawType");
	}
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "banClient":
				...
				break;
			case "clearDrawing":
				this.value.clearDrawing = this.loadObjectField(($_=new JsonParser_$f387d6e9ee8f16e56ef1d2a1cc73b0f2(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"clearDrawing",assigned,this.value.clearDrawing,pos);
				break;
			case "connected":
				...
				break;
			case "danmakuMessage":
				this.value.danmakuMessage = this.loadObjectField(($_=new JsonParser_$f378d50044c8c87339ebd29901892072(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"danmakuMessage",assigned,this.value.danmakuMessage,pos);
				break;
			case "drawCursor":
				this.value.drawCursor = this.loadObjectField(($_=new JsonParser_$1c666dcf50d5150ff2e96763d230d607(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"drawCursor",assigned,this.value.drawCursor,pos);
				break;
			case "drawEnd":
			...
			case "dump":
				...
				break;
			case "emoteMessage":
				this.value.emoteMessage = this.loadObjectField(($_=new JsonParser_$c19b4a653b84c0484a2790e2552a7ac7(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"emoteMessage",assigned,this.value.emoteMessage,pos);
				break;
			case "getTime":
			...
			case "kickClient":
				...
				break;
			case "loadDrawing":
				this.value.loadDrawing = this.loadObjectField(($_=new JsonParser_$dda5f87e2972892b16c7b833df96706a(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"loadDrawing",assigned,this.value.loadDrawing,pos);
				break;
			case "login":
			...
			case "rewind":
				...
				break;
			case "saveDrawing":
				this.value.saveDrawing = this.loadObjectField(($_=new JsonParser_$dda5f87e2972892b16c7b833df96706a(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"saveDrawing",assigned,this.value.saveDrawing,pos);
				break;
			case "serverMessage":
				...
				break;
			case "setBackground":
				this.value.setBackground = this.loadObjectField(($_=new JsonParser_$8fdfe66397f17d372f8eb5119b5b6c4d(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"setBackground",assigned,this.value.setBackground,pos);
				break;
			case "setLeader":
			...
			case "skipVideo":
				...
				break;
			case "toggleDrawing":
				this.value.toggleDrawing = this.loadObjectField(($_=new JsonParser_$dd7b5d75def09bce38d87fd906f73270(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"toggleDrawing",assigned,this.value.toggleDrawing,pos);
				break;
			case "toggleItemType":
...
var JsonParser_$8fdfe66397f17d372f8eb5119b5b6c4d = function(errors,putils,errorType) {
	if(errorType == null) {
		errorType = 0;
	}
	json2object_reader_BaseParser.call(this,errors,putils,errorType);
};
JsonParser_$8fdfe66397f17d372f8eb5119b5b6c4d.__name__ = true;
JsonParser_$8fdfe66397f17d372f8eb5119b5b6c4d.__super__ = json2object_reader_BaseParser;
JsonParser_$8fdfe66397f17d372f8eb5119b5b6c4d.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ isTransparent : Bool, color : String }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["color","isTransparent"],[false,false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			...
			case "color":
				...
				break;
			case "isTransparent":
				this.value.isTransparent = this.loadObjectField(($_=new JsonParser_$c26f15e86e3de4c398a8273272aba034(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"isTransparent",assigned,this.value.isTransparent,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { color : new JsonParser_$27118326006d3829667a400ad23d5d98([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), isTransparent : new JsonParser_$c26f15e86e3de4c398a8273272aba034([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
	,__class__: JsonParser_$8fdfe66397f17d372f8eb5119b5b6c4d
});
...
var JsonParser_$c19b4a653b84c0484a2790e2552a7ac7 = function(errors,putils,errorType) {
	if(errorType == null) {
		errorType = 0;
	}
	json2object_reader_BaseParser.call(this,errors,putils,errorType);
};
JsonParser_$c19b4a653b84c0484a2790e2552a7ac7.__name__ = true;
JsonParser_$c19b4a653b84c0484a2790e2552a7ac7.__super__ = json2object_reader_BaseParser;
JsonParser_$c19b4a653b84c0484a2790e2552a7ac7.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ html : String, clientName : String }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["clientName","html"],[false,false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			...
			case "clientName":
				...
				break;
			case "html":
				this.value.html = this.loadObjectField(($_=new JsonParser_$27118326006d3829667a400ad23d5d98(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"html",assigned,this.value.html,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { clientName : new JsonParser_$27118326006d3829667a400ad23d5d98([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), html : new JsonParser_$27118326006d3829667a400ad23d5d98([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
	,__class__: JsonParser_$c19b4a653b84c0484a2790e2552a7ac7
});
...
JsonParser_$d89734267d6f665b411f49f013149267.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ ?voiceOverTrack : Null<String>, url : String, title : String, ?subs : Null<String>, playerType : PlayerType, isTemp : Bool, isAnime : Bool, duration : Float, doCache : Bool, author : String }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["author","doCache","duration","isAnime","isTemp","playerType","subs","title","url","voiceOverTrack"],[false,false,false,false,false,false,true,false,false,true]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			...
			case "duration":
				...
				break;
			case "isAnime":
				this.value.isAnime = this.loadObjectField(($_=new JsonParser_$c26f15e86e3de4c398a8273272aba034(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"isAnime",assigned,this.value.isAnime,pos);
				break;
			case "isTemp":
...
var JsonParser_$dd7b5d75def09bce38d87fd906f73270 = function(errors,putils,errorType) {
	if(errorType == null) {
		errorType = 0;
	}
	json2object_reader_BaseParser.call(this,errors,putils,errorType);
};
JsonParser_$dd7b5d75def09bce38d87fd906f73270.__name__ = true;
JsonParser_$dd7b5d75def09bce38d87fd906f73270.__super__ = json2object_reader_BaseParser;
JsonParser_$dd7b5d75def09bce38d87fd906f73270.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ enabled : Bool }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["enabled"],[false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			...
			if(field.name == "enabled") {
				this.value.enabled = this.loadObjectField(($_=new JsonParser_$c26f15e86e3de4c398a8273272aba034(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"enabled",assigned,this.value.enabled,pos);
			} else {
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
		}
	...
	,getAuto: function() {
		return { enabled : new JsonParser_$c26f15e86e3de4c398a8273272aba034([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
	,__class__: JsonParser_$dd7b5d75def09bce38d87fd906f73270
});
...
var JsonParser_$f378d50044c8c87339ebd29901892072 = function(errors,putils,errorType) {
	if(errorType == null) {
		errorType = 0;
	}
	json2object_reader_BaseParser.call(this,errors,putils,errorType);
};
JsonParser_$f378d50044c8c87339ebd29901892072.__name__ = true;
...
var JsonParser_$f387d6e9ee8f16e56ef1d2a1cc73b0f2 = function(errors,putils,errorType) {
	if(errorType == null) {
		errorType = 0;
	}
	json2object_reader_BaseParser.call(this,errors,putils,errorType);
};
JsonParser_$f387d6e9ee8f16e56ef1d2a1cc73b0f2.__name__ = true;
JsonParser_$f387d6e9ee8f16e56ef1d2a1cc73b0f2.__super__ = json2object_reader_BaseParser;
JsonParser_$f387d6e9ee8f16e56ef1d2a1cc73b0f2.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
	...
	,__class__: JsonParser_$f387d6e9ee8f16e56ef1d2a1cc73b0f2
});
...
JsonParser_$fa535ffb25e1fd20341652f9be21e06e.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ youtubeRegion : String, youtubePlaylistLimit : Int, youtubeApiKey : String, userVideoLimit : Int, useYoutubeCrawler : Bool, unpauseWithoutLeader : Bool, twitchClientId : String, totalVideoLimit : Int, templateUrl : String, strictEmbeddingChecks : Bool, serverChatHistory : Int, ?salt : Null<String>, requestLeaderOnPause : Bool, randomVideoYoutubeApiKey : String, port : Int, permissions : Permissions, maxMessageLength : Int, maxLoginLength : Int, localNetworkOnly : Bool, localAdmins : Bool, ?isVerbose : Null<Bool>, filters : Array<Filter>, fallbackToMainApiKey : Bool, ?enableAnimeTitleTranslation : Null<Bool>, ?enableAnimeSkip : Null<Bool>, emotes : Array<Emote>, crawlerFallbackToApi : Bool, channelName : String, cacheStorageLimitGiB : Float, ?autoSkipAnimeOpenings : Null<Bool>, ?autoSkipAnimeEndings : Null<Bool>, ?animeSkipApiKey : Null<String>, allowedFileTypes : Array<String>, allowProxyIps : Bool, allowAgeRestrictedVideos : Bool }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["allowAgeRestrictedVideos","allowProxyIps","allowedFileTypes","animeSkipApiKey","autoSkipAnimeEndings","autoSkipAnimeOpenings","cacheStorageLimitGiB","channelName","crawlerFallbackToApi","emotes","enableAnimeSkip","enableAnimeTitleTranslation","fallbackToMainApiKey","filters","isVerbose","localAdmins","localNetworkOnly","maxLoginLength","maxMessageLength","permissions","port","randomVideoYoutubeApiKey","requestLeaderOnPause","salt","serverChatHistory","strictEmbeddingChecks","templateUrl","totalVideoLimit","twitchClientId","unpauseWithoutLeader","useYoutubeCrawler","userVideoLimit","youtubeApiKey","youtubePlaylistLimit","youtubeRegion"],[false,false,false,true,true,true,false,false,false,false,true,true,false,false,true,false,false,false,false,false,false,false,false,true,false,false,false,false,false,false,false,false,false,false,false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			++_g;
			switch(field.name) {
			case "allowAgeRestrictedVideos":
				this.value.allowAgeRestrictedVideos = this.loadObjectField(($_=new JsonParser_$c26f15e86e3de4c398a8273272aba034(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"allowAgeRestrictedVideos",assigned,this.value.allowAgeRestrictedVideos,pos);
				break;
			case "allowProxyIps":
			...
			case "allowedFileTypes":
				this.value.allowedFileTypes = this.loadObjectField(($_=new JsonParser_$fae276e53583ba7855144d0eb60db288(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"allowedFileTypes",assigned,this.value.allowedFileTypes,pos);
				break;
			case "animeSkipApiKey":
				this.value.animeSkipApiKey = this.loadObjectField(($_=new JsonParser_$ddce6d3de223cb2759be5c48797abca5(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"animeSkipApiKey",assigned,this.value.animeSkipApiKey,pos);
				break;
			case "autoSkipAnimeEndings":
				this.value.autoSkipAnimeEndings = this.loadObjectField(($_=new JsonParser_$f55acea3678203c700715b781ad1ef0c(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"autoSkipAnimeEndings",assigned,this.value.autoSkipAnimeEndings,pos);
				break;
			case "autoSkipAnimeOpenings":
				this.value.autoSkipAnimeOpenings = this.loadObjectField(($_=new JsonParser_$f55acea3678203c700715b781ad1ef0c(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"autoSkipAnimeOpenings",assigned,this.value.autoSkipAnimeOpenings,pos);
				break;
			...
			case "emotes":
				...
				break;
			case "enableAnimeSkip":
				this.value.enableAnimeSkip = this.loadObjectField(($_=new JsonParser_$f55acea3678203c700715b781ad1ef0c(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"enableAnimeSkip",assigned,this.value.enableAnimeSkip,pos);
				break;
			case "enableAnimeTitleTranslation":
				this.value.enableAnimeTitleTranslation = this.loadObjectField(($_=new JsonParser_$f55acea3678203c700715b781ad1ef0c(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"enableAnimeTitleTranslation",assigned,this.value.enableAnimeTitleTranslation,pos);
				break;
			case "fallbackToMainApiKey":
				this.value.fallbackToMainApiKey = this.loadObjectField(($_=new JsonParser_$c26f15e86e3de4c398a8273272aba034(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"fallbackToMainApiKey",assigned,this.value.fallbackToMainApiKey,pos);
				break;
			case "filters":
			...
			case "port":
				...
				break;
			case "randomVideoYoutubeApiKey":
				this.value.randomVideoYoutubeApiKey = this.loadObjectField(($_=new JsonParser_$27118326006d3829667a400ad23d5d98(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"randomVideoYoutubeApiKey",assigned,this.value.randomVideoYoutubeApiKey,pos);
				break;
			...
			case "serverChatHistory":
				...
				break;
			case "strictEmbeddingChecks":
				this.value.strictEmbeddingChecks = this.loadObjectField(($_=new JsonParser_$c26f15e86e3de4c398a8273272aba034(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"strictEmbeddingChecks",assigned,this.value.strictEmbeddingChecks,pos);
				break;
			case "templateUrl":
			...
			case "totalVideoLimit":
				...
				break;
			case "twitchClientId":
				this.value.twitchClientId = this.loadObjectField(($_=new JsonParser_$27118326006d3829667a400ad23d5d98(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"twitchClientId",assigned,this.value.twitchClientId,pos);
				break;
			...
			case "youtubePlaylistLimit":
				...
				break;
			case "youtubeRegion":
				this.value.youtubeRegion = this.loadObjectField(($_=new JsonParser_$27118326006d3829667a400ad23d5d98(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"youtubeRegion",assigned,this.value.youtubeRegion,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
...
server_HttpServer.prototype = {
	...
	,uploadFile: function(req,res) {
		...
		if(!this.isAllowedFileType(haxe_io_Path.extension(fileName).toLowerCase())) {
			tools_HttpServerTools.json(tools_HttpServerTools.status(res,400),{ info : "Invalid file type. Only mp4, mp3, and webm are allowed."});
			return;
		}
		var name = this.cache.getFreeFileName(fileName);
		var filePath = this.cache.getFilePath(name);
	...
	,isAllowedFileType: function(ext) {
		return this.allowedFileTypes.indexOf(ext) != -1;
	}
...
server_Main.prototype = {
	...
	,getCurrentState: function() {
		return { videoList : this.videoList.items, isPlaylistOpen : this.videoList.isOpen, itemPos : this.videoList.pos, messages : this.messages, timer : { time : this.videoTimer.getTime(), paused : this.videoTimer.isPaused()}, flashbacks : this.flashbacks, cachedFiles : this.cache.getCachedFiles(), savedDrawing : this.savedDrawing};
	}
	,loadState: function() {
		if(this.isNoState) {
			return;
		...
		state.savedDrawing = state.savedDrawing != null ? state.savedDrawing : null;
		...
		this.savedDrawing = state.savedDrawing;
	...
	,onMessage: function(client,data,internal) {
		...
		case "LoadDrawing":
			...
			if(this.savedDrawing != null) {
				this.send(client,{ type : "LoadDrawing", loadDrawing : { data : this.savedDrawing}});
			}
			break;
		case "Login":
		...
		case "SaveDrawing":
			...
			this.savedDrawing = data.saveDrawing.data;
			this.saveState();
			break;
		case "ServerMessage":
			break;
